...
void ASEGravityController::UpdateRotation(float DeltaTime)
{
...
FRotator ASEGravityController::GetGravityRelativeRotation(FRotator Rotation, FVector GravityDirection)
{
...
FRotator ASEGravityController::GetGravityWorldRotation(FRotator Rotation, FVector GravityDirection)
{
	if (!GravityDirection.Equals(FVector::DownVector))
	{
